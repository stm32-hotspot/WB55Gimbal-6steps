...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, LD2_Pin|LD3_Pin|M1_PWM_EN_U_Pin|M1_PWM_EN_V_Pin
                          |M1_PWM_EN_W_Pin|LD1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin LD3_Pin M1_PWM_EN_W_Pin LD1_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|LD3_Pin|M1_PWM_EN_W_Pin|LD1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : M1_PWM_EN_U_Pin M1_PWM_EN_V_Pin */
  GPIO_InitStruct.Pin = M1_PWM_EN_U_Pin|M1_PWM_EN_V_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
