...
void DMA1_Channel1_MC_IRQHandler(void)
{
...
/**
  ...
  */
//cstat !MISRAC2012-Rule-8.4
void USARTx_MC_IRQHandler(void)
{
  /* USER CODE BEGIN USARTx_MC_IRQHandler 0 */

  /* USER CODE END USARTx_MC_IRQHandler 0 */
  ...
  /* USER CODE BEGIN USARTx_MC_IRQHandler 1 */

  /* USER CODE END USARTx_MC_IRQHandler 1 */
}

void SysTick_MC_Handler(void)
{
