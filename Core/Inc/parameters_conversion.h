...
/*!< BEMF ADC digit threshold for zero crossing detection when BEMF is expected to decrease */
#define BEMF_THRESHOLD_DOWN                    ((uint16_t)(4096 * BEMF_THRESHOLD_DOWN_V / (BEMF_ON_SENSING_DIVIDER\
                                               * ADC_REFERENCE_VOLTAGE))) << 4
/*!< BEMF ADC digit threshold for zero crossing detection when BEMF is expected to increase */
#define BEMF_THRESHOLD_UP                      ((uint16_t)(4096 * BEMF_THRESHOLD_UP_V / (BEMF_ON_SENSING_DIVIDER\
                                               * ADC_REFERENCE_VOLTAGE))) << 4
#define BEMF_ADC_TRIG_TIME                     (uint16_t)(PWM_PERIOD_CYCLES * BEMF_ADC_TRIG_TIME_DPP / 1024)

/*!< BEMF ADC digit threshold during PWM ON time for zero crossing detection when BEMF is expected to decrease */
#define BEMF_THRESHOLD_DOWN_ON                 ((uint16_t)(4096 * BEMF_THRESHOLD_DOWN_ON_V / (BEMF_ON_SENSING_DIVIDER\
                                               * ADC_REFERENCE_VOLTAGE))) << 4
/*!< BEMF ADC digit threshold during PWM ON time for zero crossing detection when BEMF is expected to increase */
#define BEMF_THRESHOLD_UP_ON                   ((uint16_t)(4096 * BEMF_THRESHOLD_UP_ON_V / (BEMF_ON_SENSING_DIVIDER\
                                               * ADC_REFERENCE_VOLTAGE))) << 4
...
#define DEMAG_REVUP_CONV_FACTOR                (uint16_t)((DEMAG_REVUP_STEP_RATIO * PWM_FREQUENCY * SPEED_UNIT)\
                                               / (600 * POLE_PAIR_NUM ))
#define DEMAG_RUN_CONV_FACTOR                  (uint16_t)((DEMAG_RUN_STEP_RATIO * PWM_FREQUENCY * SPEED_UNIT)\
                                               / (600 * POLE_PAIR_NUM ))
